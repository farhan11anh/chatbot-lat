    ...
    <div>
        <div class="base">
            ...
            <div class="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen">
                ...
                <div id="messages" ref="messages" class="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
                   ...
                   <div v-for="item in chats" >
                       <Chat :msg="item.chat" :role="item.role"/>
                   </div>


                   <!-- <Chat msg="Halo bang" :role="chats.sender"/> -->
                   <!-- <Chat msg="Halo boy" :role="receiver"/> -->
                ...
                <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
                   <div class="relative flex">
                      ...
                      <input v-model="msg" type="text" placeholder="Write your message!" class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3">
                      <div class="absolute right-0 items-center inset-y-0 hidden sm:flex">
                         ...
                         <button @click="sendMsg" type="button" class="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none">
    ...
    export default {
        ...
        data(){
            return{
                msg : "",
                chats : [
                    {chat : "hello", role : "sender"}, 
                    {chat : "Your error message says permission denied, npm global installs must be given root privileges", role : "receiver"},
                    {chat : "Command was run with root privileges. I'm sure about that.", role : "receiver"}    
                ]
            }
        },
        methods : {
            sendMsg(){
                ...
                let response = ['Yo ndak tau, kok tanya saya!!!', 'Mau Tau aja atau mau tau banget ?', 'takok chat gpt kono !!!']
